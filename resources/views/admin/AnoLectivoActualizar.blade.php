 ...
 <!-- Modal Registar-->
 <div class=" modal fade" data-backdrop="static" data-keyboard="false" id="Modal_Actualizar_anoLectivo" tabindex="-1" aria-labelledby="Modal_Actualizar_anoLectivo" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="Modal_Registar_anoLectivo">Actualizar ano Lectivo</h5>
                <button type="button" class="close fecharX" data-dismiss="modal">
                    <span >&times;</span>
                </button>
            </div>

            <form action="/ano_lectivo/actualizar" method="Post" enctype="multipart/form-data">
                @csrf
